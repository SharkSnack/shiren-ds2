...
It doesn't gain experience points, but instead levels up when specific items are thrown at it.<br/>※ The item's name has to be an exact match, along with blessed/cursed status + runes.
